    ...
    <>
                      ...
                      <div className="min-w-[57px] max-w-[57px] max-h-[57px] md:min-w-[72px] min-h-[57px] md:min-h-[72px] md:max-w-[72px] md:max-h-[72px] rounded-[3px] bg-green">
                        {item?.thumbnailUrl && (
                          ...
                          <img
                            ...
                            alt=""
                            className="relative min-w-[57px] max-w-[57px] max-h-[57px] md:min-w-[72px] min-h-[57px] md:min-h-[72px] md:max-w-[72px] md:max-h-[72px] object-cover"
                          />
                        )}
                      </div>
      ...
      {data?.length === 0 && (
        <div className="flex justify-center items-center">
          <AktivGroteskText
            text={cmsData.leaderboard.noDataFoundText}
            fontSize="text-[16px] md:text-[20px]"
            fontWeight="font-[700]"
          />
        </div>

...
const HomePageSurpriseButton = () => {
  ...
  const { triggerAnimation, isAnimating, animationKey } = useCoinAnimation()
  ...
  return (
    <>
      <button
        ...
        className='fixed cursor-pointer md:top-[50%] top-[68%] right-[10px] border-[1px] border-[#11A64B] rounded-[100px] max-w-[98px] md:max-w-[160px]
    py-[8px] pl-[5px] pr-[8px] md:px-[4px] md:py-[4px] flex items-center gap-[5px] bg-yellow'
      >

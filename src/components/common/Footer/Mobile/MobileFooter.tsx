      ...
      <div className="h-[54px] w-full bg-white text-black border-t border-gray-200">
        <div className="flex justify-evenly items-center h-full">
          ...
          >
            ...
            <span className="text-black text-[9px] mt-1 font-medium">HOME</span>
          </Link>
          ...
          >
            ...
            <span className="text-black text-[9px] mt-1 font-medium">
              CONTEST
            </span>
          </Link>
          ...
          >
            <div className="relative">
              <Image src={comicCoin} alt="comic-coins" width={24} height={24} />
              <div
                className="absolute -top-1 -right-1 bg-yellow-400 text-white
               text-[7px] px-1 py-0.5 rounded-full font-bold bg-black"
              >
                0
              </div>
            </div>

...
const Signup = () => {
  ...
  // Fetch notification count after successful signup
  ...
  useEffect(() => {
    if (signupData?.ok) {
      ...
      if (
        ...
        // Fetch notifications after successful signup
        console.log("Fetching notifications after successful signup");
        refetchNotifications();

        // Fetch notification count after successful signup to update badge
        console.log("Fetching notification count after successful signup");

...
const OtpModal = () => {
  ...
  useEffect(() => {
    if (verifyOTPData?.ok) {
      ...
      // Fetch notifications after successful login
      console.log("Fetching notifications after successful login");
      refetchNotifications();

      // Fetch notification count after successful login to update badge
      console.log("Fetching notification count after successful login");

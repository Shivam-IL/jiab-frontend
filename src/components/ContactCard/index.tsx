...
const ContactCard: React.FC<ContactCardProps> = ({
  ...
  return (
    ...
    >
      <button
        className="bg-white rounded-lg max-w-md mx-2 flex flex-col w-[400px] h-[400px]"
      ...
      >
        ...
        <div className="px-[24px] pb-[20px]">
          ...
          <div className="text-center mb-[10px]">
            ...
            <p className="text-[16px] pb-[8px]">indiahelpline@coca-cola.com</p>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-black">
              <p className="text-[16px] font-semibold mb-2">1800 208 2653</p>
              <p className="text-[16px]">9:00am-9:00pm (Mon-Sat)</p>
              <p className="text-[16px]">9:00am-6:00pm (Sun)</p>
            </div>
          </div>
        </div>
      </button>
